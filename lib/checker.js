...
var LONG_MSG_BITS = exports.LONG_MSG_BITS = 112
var SHORT_MSG_BITS = exports.SHORT_MSG_BITS = 56

exports.checksum = function(data, bits) {
  if (!bits) {
    if (data.length * 8 === SHORT_MSG_BITS) {
      bits = SHORT_MSG_BITS
    } else if (data.length * 8 === LONG_MSG_BITS) {
      bits = LONG_MSG_BITS
    } else {
  ...
  var crc = 0
  var offset = (bits === LONG_MSG_BITS) ?
    0 : (LONG_MSG_BITS - SHORT_MSG_BITS)
